    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={[styles.header, { backgroundColor: colors.surface }]}>
          ...
          <View style={[styles.badge, { backgroundColor: isDark ? '#1A2E3D' : '#E8F4FD' }]}>
        ...
        <View style={[styles.section, { backgroundColor: colors.surface }]}>
          ...
          >
            ...
            <Text style={[styles.menuText, { color: colors.textPrimary }]}>Dados da Clínica</Text>
          ...
          <TouchableOpacity style={[styles.menuItem, { borderBottomColor: colors.borderLight }]}>
            ...
            <Text style={[styles.menuText, { color: colors.textPrimary }]}>Gerenciar Equipe</Text>
            <Ionicons name="chevron-forward" size={24} color={colors.textTertiary} />
          </TouchableOpacity>
