...
const UPGRADE_PLANS = [
  { key: 'clinic_essencia', name: 'Essência', monthly: 800, setupFee: 350, invitedPatients: 15, psychologists: 3 },
  { key: 'clinic_amplitude', name: 'Amplitude', monthly: 1200, setupFee: 350, invitedPatients: 25, psychologists: 5 },
];
    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
        <View style={[styles.header, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}>
          ...
          <Text style={[styles.title, { color: colors.textPrimary }]}>Faturamento</Text>
          <View style={{ width: 40 }} />
        </View>
              ...
              <View style={{ flex: 1 }}>
                <Text style={[styles.limitsText, { color: colors.textSecondary }]}>
                  ...
                  <Text style={{ fontWeight: '700', color: colors.textPrimary }}>
                    {subscription.limits.psychologists !== null
                      ? `até ${subscription.limits.psychologists}`
                      : 'Ilimitado'}
                  </Text>
                </Text>
                <Text style={[styles.limitsText, { color: colors.textSecondary }]}>
...
const styles = StyleSheet.create({
  ...
  limitsText: { fontSize: 14, marginBottom: 2 },
  upgradeButton: {
    flexDirection: 'row',
    alignItems: 'center',
